		...
		<div className="card">
			...
			<div className="flex my-4 divide-y-2 w-4/5 mx-auto">
				<span className="isolate inline-flex shadow-sm">
					<button type="button" className="shadow relative border inline-flex items-center bg-white px-3 py-2 text-sm text-gray-900 ring-gray-300 hover:bg-gray-50 focus:z-10">Article</button>
				...
				<input className="flex-grow shadow appearance-none border w-fit py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Search" />
			</div>
