				...
				<div className="flex relative h-screen w-5/6">
					...
					<div className="flex flex-col w-full content-between items-between relative my-auto">
						<div className="items-end mr-16 ml-5">
							...
							<div className="grid grid-cols-2 text-center gap-1 mt-8 font-mono ml-12 text-lg">
							...
							<div className="flex flex-row-reverse text-xl mt-2 gap-x-4">
								<span className={styles.clickableIconWrapper}>
									<Link className="mgc_mail_line" href={'mailto:ranzeplay@outlook.com'}></Link>
								</span>
								<span className={styles.clickableIconWrapper}>
									<Link className="mgc_telegram_line drop-shadow-sm" target='blank' href={''}></Link>
								</span>
								<span className={styles.clickableIconWrapper}>
									<Link className="mgc_twitter_line drop-shadow-sm" target='blank' href={'https://twitter.com/ranzeplay'}></Link>
								</span>
								<span className={styles.clickableIconWrapper}>
									<Link className="mgc_github_line drop-shadow-sm" target='blank' href={'https://github.com/Ranzeplay'}></Link>
								</span>
								<span className={styles.clickableIconWrapper}>
									<Link className='drop-shadow-sm text-white' target='blank' href={'https://space.bilibili.com/102116986'}>
